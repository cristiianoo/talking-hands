      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 24, paddingBottom: 40 }}>
        ...
        <View className="mb-8 mt-2">
          ...
          <Text className="text-gray-500 mt-2 text-base">
            Completa os níveis para dominares a LGP.
          </Text>
        </View>

        {/* Nível 1 - Concluído */}
        <View className="flex-row items-center mb-8 opacity-60">
          <View className="bg-primary rounded-full w-14 h-14 items-center justify-center mr-4 shadow-sm">
            <Check size={28} color="white" strokeWidth={3} />
          </View>
          <View className="flex-1">
            <Text className="text-xl font-bold text-gray-900">Nível 1</Text>
            <Text className="text-gray-500">Saudações e Cumprimentos</Text>
          </View>
        </View>

        {/* Linha de ligação (Estilo Mapa) */}
        <View className="absolute left-[52px] top-[140px] bottom-[180px] w-1 bg-gray-200 -z-10 rounded-full" />

        {/* Nível 2 - Atual (Em Progresso) */}
        <TouchableOpacity activeOpacity={0.8} className="flex-row items-center mb-8">
          <View className="bg-primary rounded-full w-16 h-16 items-center justify-center mr-4 shadow-md border-4 border-green-100">
        ...
        <View className="flex-row items-center opacity-50">
          ...
          <View className="flex-1">
            <Text className="text-xl font-bold text-gray-900">Nível 4</Text>
            <Text className="text-gray-500">Família</Text>
          </View>
        </View>
